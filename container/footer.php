            ...
            <div class="row gy-4">
                <div class="col-lg-12  col-sm-12">
                    <div class="service-wrapper free-shipping">
                            ...
                            <h2 class="service-info service-title">PRICES ARE PER POUND - SELLER PAYS ALL SHIPPING COSTS</h2>
                            <p class="service-info service-details">Scrapify.com and it's authorized agents reserve the right to upgrade or downgrade any material.All prices are subject to change without notice.</p>
