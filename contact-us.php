               ...
               <div class="row align-items-center gy-5" id="Welcome-to-Scrapify">
                  ...
                  <div class="col-lg-6">
                     <div class="about-content" data-aos="fade-left">
                        ...
                        <h5 class="about-info">
                        Connect with us today for all your inquiries and assistance.
                    </h5>
                    ...
                    <div class="col-lg-6">
                        <div class="contact-info-section">
                            <div class="contact-information">
                                <h5 class="wrapper-heading" style="text-align: center;">Contact Information</h5>
                                <p class="paragraph" style="text-align: center;">Fill the form below or write us .We will help you as soon as
                                    possible.</p>
                                                ...
                                                <div class="wrapper-img">
                                                    <span>
                                                        <svg width="44" height="44" viewBox="0 0 44 44" fill="none"
                                                            ...
                                                            <circle cx="22" cy="22" r="21.5" stroke="rgba(0, 218, 108, 1)"></circle>
                                                            <path
                                                                ...
                                                                fill="rgba(0, 218, 108, 1)" stroke="rgba(0, 218, 108, 1)"></path>
                                                            <path
                    ...
                    <div class="col-lg-6">
                        <div class="question-section login-section ">
                            <div class="review-form">
                                ...
                                <div class="login-btn">
                                    <a href="#" style="background:rgba(0, 218, 108, 1);" class="shop-btn">Send Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
